                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="samitiyuva.php">Yuva Sewa Samiti</a></li>
                                <li><a href="samitimahila.php">Mahila Sewa Samiti</a></li>
								<li><a href="family.php">Families</a></li>
                                <li><a href="pdf/Maheshwari Unmarried Member Form.pdf">Unmarried</a></li>
                            </ul>
                        </li>
