	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="big-cta">
					<div class="cta-text">
						<h2><span>Maheshwari</span> Bas Naam Hi Kaafi Hai</h2>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>We are called Maheshwaris taking the name from Lord Mahesh or Lord Shiva. </p>									
							</div>
							<div class="box-bottom"><a href="history.php">Know more</a></div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
                                ...
                                <p>	 Seventy two surnames (khaps) formed the primary Maheshwari list of surnames. </p>		
							</div>
							<div class="box-bottom">		<a href="surnames.php">Know more</a>	</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>	We celebrate each festival with full enjoyment and with all maheshwari families.	</p>									
							</div>
							<div class="box-bottom">	<a href="festival.php">Know more</a>	</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="box">
							<div class="box-gray aligncenter">
								<h4>Our Traditions</h4>
								<div class="icon">
								<i class="fa fa-code fa-3x"></i>
								</div>
								<p>	 A good culture makes a man feelsensible in his mind and is loved by all	</p>
									
							</div>
							<div class="box-bottom">		<a href="tradition.php">Know more</a>	</div>
						</div>
					</div>
				</div>
			</div>
